...
export const Cosmetico = ({ name, src, precio, descripcion }) => {
     ...
     <body>
        <div className="container">
            <div className="card">
                ...
                <p>{precio}</p>
                <p>{descripcion}</p>           
                <Button className="btn" variant="light" onClick={() => añadirAlCarrito({name: name, tipo: 'Cosmético', descripcion: descripcion, precio: precio, cantidad: '1'}) }>Añadir al carrito</Button>                 
